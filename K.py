...
# Function to classify the "K" gesture
def classify_k_gesture(landmarks1, landmarks2):
    index_tip_1 = landmarks1[7]
    index_tip_2 = landmarks2[6]
    middle_tip_1 = landmarks1[7]
    middle_tip_2 = landmarks2[10]

    # Calculate distance between the index fingers of both hands
    distance_threshold = 0.1  # Adjust this threshold as needed
    distance_1 = calculate_distance(index_tip_1, index_tip_2)
    distance_2 = calculate_distance(middle_tip_1, middle_tip_2)

    # Check if index tip of one hand touches middle tip of the other hand
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        if len(results.multi_hand_landmarks) == 2:
            ...
            # Classify the K gesture
            gesture = classify_k_gesture(hand_landmarks1.landmark, hand_landmarks2.landmark)
