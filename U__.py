...
def classify_u_gesture(landmarks, a1, a2, a3, a4):
    ...
    d2 = (thumb_tip.y - index_tip.y)**2 + (thumb_tip.x - index_tip.x)**2
    d3 = (thumb_tip.y - landmarks[6].y)**2 + (thumb_tip.x - landmarks[6].x)**2
    d4 = (thumb_tip.y - landmarks[5].y)**2 + (thumb_tip.x - landmarks[5].x)**2
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Classify gesture
            gesture, accuracy, correct = classify_u_gesture(hand_landmarks.landmark, angle_2d_1, angle_2d_2, angle_2d_3, angle_2d_4)
