...
# Function to classify the "N" gesture
def classify_n_gesture(landmarks1, landmarks2):
    wrist = landmarks2[17]
    ...
    if is_point_above_line(index_finger, wrist, palm_base) and \
       is_point_above_line(middle_finger, wrist, palm_base):
        return "Not N"
    return "N"
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks and len(results.multi_hand_landmarks) == 2:
        ...
        gesture = classify_n_gesture(hand_landmarks1.landmark, hand_landmarks2.landmark)
