...
# Function to classify the "X" gesture
def classify_t_gesture(landmarks1, landmarks2):
    if calculate_distance(landmarks1[6], landmarks2[6]) < distance_threshold or \
       calculate_distance(landmarks2[6], landmarks1[6]) < distance_threshold:
        return "X"
    return "Not X"
...
while cap.isOpened():
    ...
    # Initialize the gesture as 'Not X'
    gesture = "Not X"
