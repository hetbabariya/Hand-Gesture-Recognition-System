...
def classify_y_gesture(landmarks1,landmarks2):
    thumb_tip_1 = landmarks1[4]
    index_tip_1 = landmarks1[8]
    middle_tip_1 = landmarks1[12]
    ring_tip_1 = landmarks1[16]
    little_tip_1 = landmarks1[20]

    middle_part_of_T_and_I = landmarks1[2]
    ...
    distance_hand = calculate_distance(index_tip_2, middle_part_of_T_and_I)


    # Check if middle, ring, or little finger is above thumb or index finger
    if middle_tip_1.y < thumb_tip_1.y or middle_tip_1.y < index_tip_1.y or \
       ring_tip_1.y < thumb_tip_1.y or ring_tip_1.y < index_tip_1.y or \
       little_tip_1.y < thumb_tip_1.y or little_tip_1.y < index_tip_1.y:
        return "Not Y"
    else:
        if distance_hand < distance_threshold:
            return "Y"
    ...
    little_tip_2 = landmarks2[20]

    middle_part_of_T_and_I = landmarks2[2]
    ...
    distance_hand = calculate_distance(index_tip_1, middle_part_of_T_and_I)


    # Check if middle, ring, or little finger is above thumb or index finger
    if middle_tip_2.y < thumb_tip_2.y or middle_tip_2.y < index_tip_2.y or \
       ring_tip_2.y < thumb_tip_2.y or ring_tip_2.y < index_tip_2.y or \
       little_tip_2.y < thumb_tip_2.y or little_tip_2.y < index_tip_2.y:
        return "Not Y"
    else:
        if distance_hand < distance_threshold:
            return "Y"
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        if len(results.multi_hand_landmarks) == 2:
            ...
            gesture = classify_y_gesture(hand_landmarks1.landmark, hand_landmarks2.landmark)
