...
# Function to classify the "R" gesture
def classify_r_gesture(landmarks1, landmarks2):
    wrist = landmarks2[17]
    palm_base = landmarks2[0]

    # Check if the finger is above the line between wrist and palm base
    if is_point_above_line(landmarks1[8], wrist, palm_base) and \
       is_point_above_line(landmarks1[7], wrist, palm_base) and \
       is_point_above_line(landmarks1[6], wrist, palm_base):
        return "Not R"
    return "R"
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks and len(results.multi_hand_landmarks) == 2:
        ...
        # Classify the R gesture
        gesture = classify_r_gesture(hand_landmarks1.landmark, hand_landmarks2.landmark)
